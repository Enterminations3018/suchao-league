using Jiangsu_City_League_Blazor_ASP.NET.Models;

namespace Jiangsu_City_League_Blazor_ASP.NET.Services;
...
public class LeagueService
{
    ...
    private List<Match> InitializeMatches()
    {
        ...
        // 第1-9周真实赛果（来源：南京本地宝官方赛程表）
        var completedMatches = new List<(int home, int away, int homeScore, int awayScore, int round, DateTime date)>
        {
            // 第1周 (4月11日)
            (4, 5, 3, 0, 1, new DateTime(2026, 4, 11)),   // 常州3-0南通
            (8, 2, 0, 1, 1, new DateTime(2026, 4, 11)),   // 扬州0-1苏州
            (3, 9, 3, 1, 1, new DateTime(2026, 4, 11)),   // 无锡3-1镇江
            (12, 7, 0, 2, 1, new DateTime(2026, 4, 11)),  // 连云港0-2盐城
            
            // 第2周 (4月18日)
            (13, 1, 2, 0, 2, new DateTime(2026, 4, 18)),  // 宿迁2-0南京
            (11, 8, 1, 1, 2, new DateTime(2026, 4, 18)),  // 淮安1-1扬州
            (6, 10, 3, 0, 2, new DateTime(2026, 4, 18)),  // 徐州3-0泰州
            
            // 第3周 (4月25日)
            (12, 3, 0, 0, 3, new DateTime(2026, 4, 25)),  // 连云港0-0无锡
            (5, 6, 0, 0, 3, new DateTime(2026, 4, 25)),   // 南通0-0徐州
            (7, 13, 1, 0, 3, new DateTime(2026, 4, 25)),  // 盐城1-0宿迁
            
            // 第4周 (5月2日)
            (1, 4, 2, 1, 4, new DateTime(2026, 5, 2)),    // 南京2-1常州
            (10, 8, 3, 1, 4, new DateTime(2026, 5, 2)),   // 泰州3-1扬州
            (2, 11, 0, 1, 4, new DateTime(2026, 5, 2)),   // 苏州0-1淮安
            (9, 7, 1, 2, 4, new DateTime(2026, 5, 2)),    // 镇江1-2盐城
            
            // 第5周 (5月9日)
            (3, 10, 3, 1, 5, new DateTime(2026, 5, 9)),   // 无锡3-1泰州
            (5, 1, 0, 0, 5, new DateTime(2026, 5, 9)),    // 南通0-0南京
            (6, 13, 1, 2, 5, new DateTime(2026, 5, 9)),   // 徐州1-2宿迁
            
            // 第6周 (5月16日)
            (4, 11, 1, 2, 6, new DateTime(2026, 5, 16)),  // 常州1-2淮安
            (2, 12, 2, 2, 6, new DateTime(2026, 5, 16)),  // 苏州2-2连云港
            (8, 9, 1, 0, 6, new DateTime(2026, 5, 16)),   // 扬州1-0镇江
            
            // 第7周 (5月23日)
            (11, 7, 0, 1, 7, new DateTime(2026, 5, 23)),  // 淮安0-1盐城
            (12, 6, 1, 3, 7, new DateTime(2026, 5, 23)),  // 连云港1-3徐州
            (13, 5, 1, 2, 7, new DateTime(2026, 5, 23)),  // 宿迁1-2南通
            
            // 第8周 (5月30日)
            (10, 2, 1, 2, 8, new DateTime(2026, 5, 30)),  // 泰州1-2苏州
            (7, 8, 1, 0, 8, new DateTime(2026, 5, 30)),   // 盐城1-0扬州
            (9, 4, 0, 2, 8, new DateTime(2026, 5, 30)),   // 镇江0-2常州
            (3, 1, 0, 2, 8, new DateTime(2026, 5, 30)),   // 无锡0-2南京
            
            // 第9周 (6月13日)
            (6, 3, 0, 1, 9, new DateTime(2026, 6, 13)),   // 徐州0-1无锡
            (13, 9, 3, 0, 9, new DateTime(2026, 6, 13)),  // 宿迁3-0镇江
            (5, 10, 0, 1, 9, new DateTime(2026, 6, 13))   // 南通0-1泰州
        };
        ...
        {
            (4, 7, 10, new DateTime(2026, 6, 20)),   // 常州vs盐城
            (8, 12, 10, new DateTime(2026, 6, 20)),  // 扬州vs连云港
            (2, 5, 10, new DateTime(2026, 6, 20)),   // 苏州vs南通
            (1, 11, 10, new DateTime(2026, 6, 20))   // 南京vs淮安
        };
